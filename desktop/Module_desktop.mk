...
$(eval $(call gb_Module_add_targets,desktop,\
    $(if $(BUILD_FOR_ALIOS),,Executable_soffice_bin) \
    $(if $(BUILD_FOR_ALIOS),,Executable_unopkg_bin) \
    $(if $(ENABLE_BREAKPAD),Executable_minidump_upload) \
    Library_migrationoo2 \
    Library_migrationoo3 \
    Library_unopkgapp \
    Library_officekit \
    Library_officekitint \
    $(if $(BUILD_FOR_ALIOS),,Executable_officekit_bin) \
    Package_scripts \
))
