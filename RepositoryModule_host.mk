...
$(eval $(call gb_Module_add_moduledirs,libreoffice,\
	...
	$(if $(BUILD_FOR_ALIOS),offapi,offapi) \
	officecfg \
	onlineupdate \
	$(if $(BUILD_FOR_ALIOS),oovbaapi,oovbaapi) \
	$(if $(BUILD_FOR_ALIOS),alios) \
	oox \
	...
	swext \
	sysui \
	$(if $(BUILD_FOR_ALIOS),,test) \
	testtools \
	toolkit \
	tools \
	ucb \
	ucbhelper \
	$(if $(BUILD_FOR_ALIOS),udkapi,udkapi) \
	$(call gb_Helper_optional,PYUNO,uitest) \
	UnoControls \
	unodevtools \
	unoil \
	unoidl \
	$(if $(BUILD_FOR_ALIOS),,unotest) \
	unotools \
	unoxml \
	ure \
	uui \
