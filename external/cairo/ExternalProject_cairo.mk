...
$(call gb_ExternalProject_get_state_target,cairo,build) :
	...
	./configure \
		...
		LIBS="$(ZLIB_LIBS)" \
		pixman_CFLAGS=$(if $(BUILD_FOR_ALIOSx),"$(PIXMAN_CFLAGS)","-I$(call gb_UnpackedTarball_get_dir,pixman)/pixman") \
		pixman_LIBS=$(if $(BUILD_FOR_ALIOSx),"$(PIXMAN_LIBS)","-L$(call gb_UnpackedTarball_get_dir,pixman)/pixman/.libs -lpixman-1" )\
