...
$(eval $(call gb_Rdb_add_components,services,\
	...
	$(if $(BUILD_FOR_ALIOS),,filter/source/flash/flash) \
	...
	$(if $(BUILD_FOR_ALIOS),,filter/source/t602/t602filter) \
	$(if $(BUILD_FOR_ALIOS),,filter/source/textfilterdetect/textfd) \
	filter/source/xmlfilteradaptor/xmlfa \
	$(if $(BUILD_FOR_ALIOS),,filter/source/xmlfilterdetect/xmlfd) \
	$(if $(BUILD_FOR_ALIOS),,filter/source/xsltdialog/xsltdlg) \
	$(if $(BUILD_FOR_ALIOS),,filter/source/xsltfilter/xsltfilter) \
	formula/util/for \
	$(call gb_Helper_optional,DESKTOP,fpicker/source/office/fps_office) \
	framework/util/fwk \
	framework/util/fwl \
	framework/util/fwm \
	$(if $(BUILD_FOR_ALIOS),,hwpfilter/source/hwp) \
...
$(eval $(call gb_Rdb_add_components,services,\
	$(if $(BUILD_FOR_ALIOS),,extensions/source/bibliography/bib) \
	$(if $(BUILD_FOR_ALIOS),,extensions/source/dbpilots/dbp) \
	$(if $(BUILD_FOR_ALIOS),,extensions/source/propctrlr/pcr) \
...
$(eval $(call gb_Rdb_add_components,services,\
	...
	$(if $(BUILD_FOR_ALIOS),,extensions/source/abpilot/abp) \
	$(if $(BUILD_FOR_ALIOS),,extensions/source/config/ldap/ldapbe2) \
	$(if $(BUILD_FOR_ALIOS),,extensions/source/logging/log) \
	$(if $(BUILD_FOR_ALIOS),,extensions/source/scanner/scn) \
