...
$(call gb_ExternalProject_get_state_target,pixman,build) :
	$(call gb_ExternalProject_run,build,\
		...
		$(if $(filter ANDROID,ANDROID $(OS)),--disable-arm-simd --disable-arm-neon --disable-arm-iwmmxt) \
		$(if $(CROSS_COMPILING),--build=$(BUILD_PLATFORM) --host=$(HOST_PLATFORM) \
        --disable-openmp --disable-loongson-mmi --disable-sse2 --disable-ssse3 --disable-vmx --disable-mmx \
